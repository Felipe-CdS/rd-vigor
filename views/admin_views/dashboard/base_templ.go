...
func UsersList(users []repositories.User) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 50, Col: 64}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(")</h1><button class=\"ml-auto\" title=\"filtrar\"><img class=\"size-6\" src=\"static/img/filter.svg\"></button></div><div x-data=\"{selected: &#39;&#39;}\" class=\"flex overflow-y-scroll relative flex-col w-full\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, usr := range users {
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("dashboard/details?user=%d", usr.ID))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 61, Col: 62}
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var5))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" hx-target=\"#user-info-div\" hx-swap=\"outerHTML\" class=\"flex flex-col items-start p-4 w-full border-b border-gray-200 border-solid\" :id=\"$id(&#39;user&#39;)\" x-on:click=\"selected = $el.id\" x-bind:style=\"$el.id == selected &amp;&amp; { &#39;border-left&#39;: &#39;4px solid #ED6C09&#39; }\"><h1 class=\"text-sm font-medium\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 69, Col: 52}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 69, Col: 69}
			}
			...
			templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.JoinStringErrs(usr.OccupationArea)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 70, Col: 71}
			}
...
func UserInfoDiv(user repositories.User) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 84, Col: 20}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 85, Col: 19}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 98, Col: 24}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 110, Col: 28}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 124, Col: 33}
		}
		...
		if user.ReferFriend != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 137, Col: 31}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 144, Col: 32}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 159, Col: 49}
		}
		...
		if !user.CreatedAt.IsZero() {
			...
			templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(user.CreatedAt.Format(time.RFC822Z))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 172, Col: 50}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 179, Col: 42}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/admin_views/dashboard/base.templ`, Line: 194, Col: 34}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var20))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" class=\"py-1 px-2 mt-1 font-normal text-gray-800 bg-gray-200 rounded-md\"></label></div><hr class=\"my-2 w-full h-px bg-gray-200 border-0\"><h1 class=\"text-gray-500 text-md\">Ações</h1><div class=\"flex mt-1 space-x-3 w-full\"><form hx-post=\"\" class=\"flex flex-col space-y-1 w-1/2 text-sm text-gray-400\"><label>Alterar situação cadastral</label><div class=\"flex mt-1 space-x-2 w-full\"><select class=\"flex py-1 px-2 font-normal text-gray-800 bg-gray-200 rounded-md grow\"><option value=\"rejected\">Rejeitado</option> <option value=\"pending\">Pendente</option> <option value=\"accepted\">Aceito</option></select> <button class=\"w-1/5 rounded-md text-white bg-[#FC8713]\">Salvar</button></div></form></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
