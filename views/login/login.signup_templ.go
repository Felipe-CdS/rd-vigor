...
func SignupForm() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex justify-between w-full\"><div><h1 class=\"text-2xl font-bold\">Pré-cadastro</h1><h1 class=\"text-sm text-gray-400\">Crie a sua conta agora e tenha a oportunidade de ser um dos primeiros na RD Vigor!</h1></div><button hx-get=\"/login\" hx-target=\"#form-box\" class=\"size-10\"><img class=\"w-full\" src=\"static/img/close.svg\"></button></div><hr class=\"w-full h-px bg-gray-200 border-0\"><form hx-post=\"/signup\" hx-target=\"#form-box\" hx-encoding=\"multipart/form-data\" class=\"flex flex-col space-y-3 w-full\"><div class=\"flex justify-between items-center space-x-3 w-full\"><input type=\"text\" name=\"first_name\" placeholder=\"Primeiro Nome\" class=\"py-3 px-4 w-full font-normal rounded-md border border-gray-200 border-solid\"> <input type=\"text\" name=\"last_name\" placeholder=\"Sobrenome\" class=\"py-3 px-4 w-full font-normal rounded-md border border-gray-200 border-solid\"></div><input type=\"email\" name=\"email\" placeholder=\"E-mail\" class=\"py-3 px-4 w-full font-normal rounded-md border border-gray-200 border-solid\"> <input type=\"text\" name=\"telephone\" placeholder=\"Telefone\" class=\"py-3 px-4 w-full font-normal rounded-md border border-gray-200 border-solid\"> <input type=\"password\" name=\"password\" placeholder=\"Nova senha\" class=\"py-3 px-4 w-full font-normal rounded-md border border-gray-200 border-solid\"> <input type=\"password\" name=\"repeat-password\" placeholder=\"Repita a senha\" class=\"py-3 px-4 w-full font-normal rounded-md border border-gray-200 border-solid\"> <input type=\"text\" name=\"occupation_area\" placeholder=\"Area de atuação\" class=\"py-3 px-4 w-full font-normal rounded-md border border-gray-200 border-solid\"> <button type=\"submit\" data-loading-disable data-loading-class=\"hidden\" class=\"p-3 w-full font-semibold text-lg rounded-md text-white bg-[#FFBD59]\">Criar Conta</button> <button disabled data-loading class=\"p-3 w-full font-semibold text-lg rounded-md text-white bg-[#ffdfa9]\">Enviando...</button></form>")
